import 'package:izipay_sdk/izipay_sdk_method_channel.dart';
...
abstract class FlutterIzipayPlatform extends PlatformInterface {
  ...
  Future<void> payWithCard(Map<String, String> allConfigs) {
    throw UnimplementedError('payWithCard() has not been implemented.');
  }

  Future<void> payWithYape(Map<String, String> allConfigs) {
    throw UnimplementedError('payWithYape() has not been implemented.');
  }
}
